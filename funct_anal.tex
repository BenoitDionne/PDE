...
\]
then we have an isometry between $\displaystyle L^2(T,\nu)$ and $P$ defined by
\begin{align*}
Q: L^2(T,\nu) & \rightarrow P \\
  f & \mapsto f(e^{x\,i})
\end{align*}
...
$\displaystyle 0< p^2 C^2 - 2pc +1 <1$, then we
...
$\displaystyle \RE B(w,u) = \RE \tilde{u}(w)$ for all $w \in H$
if and only if
$\displaystyle \RE B(i w,u) = \RE \tilde{u}(iw)$ for all $w \in H$
if and only if
$\displaystyle \RE (i B(w,u)) = \RE (i\tilde{u}(w))$ for all $w \in H$
