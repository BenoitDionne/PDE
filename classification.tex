...
$\displaystyle (\zeta_1,\zeta_2) \in \RR^2 \setminus \{(0,0)\}$ or
$Q(x,y,\zeta_1,\zeta_2) < 0$ for all
$\displaystyle (\zeta_1,\zeta_2) \in \RR^2 \setminus \{ (0,0)\}$
...
\]
If we solve $\displaystyle \dydx{y}{x} = \phi_{+}(x,y)$, then we get a family
...
\]
is an example of a parabolic equation on all $\displaystyle \RR^2$.
\end{egg}
...
for $(x,y)$ and $\displaystyle \xi_1,\xi_2)$ in $\RR^2$.
\end{defn}
