...
\end{equation}
where $\displaystyle a:\RR^3\rightarrow \RR$ and
$\displaystyle b:\RR^3\rightarrow \RR$ are
...
divide the result by $\displaystyle e^{ik\phi(x,y)}$, then we get
\[
...
$G'(y) + \alpha G(y) = 0$,
whose general solutions are $\displaystyle F(x) = \beta_1 e^{\alpha x}$ and
