...
we get that $\displaystyle \diff^{\VEC{\alpha}} \underline{f}
= \underline{\diff^{\VEC{\alpha}} f}$
...
$f_\delta \to f_0 = f$ in $\displaystyle W^{k,p}(U)$ as
...
$\displaystyle \delta \to 0^+$.  Since this is true for all
multi-indices $\VEC{\alpha}$ such that $|\VEC{\alpha}|\leq k$, we get that
$\displaystyle \|\diff^{\VEC{\alpha}} f_\delta
...
- f\|_{k,p} \rightarrow 0$ as $\displaystyle \epsilon \rightarrow 0^+$.
...
$\psi_\delta - \psi \to 0$ as $\displaystyle \delta \to 0^+$ in
$\displaystyle L^2(\RR^n)$
follows from the Lebesgue Dominate Convergence Theorem
since $\psi_{\delta}(\VEC{x}) \to \psi(\VEC{x})$ for all
$\displaystyle \VEC{x} \in \RR^n$ as $\displaystyle \delta \to 0^+$ and
...
For $\displaystyle \phi \in \SS(\RR^n)$ and $s\in [0,\infty[$, the mapping
\begin{align*}
...
But since $\displaystyle \DD(\Omega) \subset C^k_c(\Omega$, we also have that
...
Let $\Omega$ be an open subset of $\displaystyle \RR^n$.  If
...
$\displaystyle \Omega \subset \RR^n$.  The answer is positive for
...
For $\displaystyle \phi \in \SS(\RR^n)$, we have
\begin{align*}
...
Given $\displaystyle f \in H^{-s,2}(\RR^n)$, we have
\begin{align*}
...
$\displaystyle \VEC{x} \in \RR^n\setminus \Omega$ to get that
...
$\displaystyle E(\phi) \in C^m(\RR^n)$ for $\phi \in S$.
...
Let $\displaystyle \Omega \subset \RR^n$ be a bounded open set with the
...
$\displaystyle \breve{\VEC{x}} \in \RR^{n-1}$ and $x_n \in \RR$.
Since \\
...
Given $\displaystyle \phi \in \SS(\RR^n)$, we have
\[
...
$\displaystyle \VEC{z} \in \RR^{n-1}$, then we have
\[
...
$\displaystyle y = \sqrt{1+\|\VEC{w}\|^2}\, z$, we get
\[
...
we only have to defined the mapping $S_0$ on $\displaystyle \SS(\RR^{n-1})$.
...
= \phi(\VEC{z})
\end{align*}
for all $\displaystyle \VEC{z} \in \RR^{n-1}$, we get
\[
...
for $\displaystyle \phi \in \SS(\RR^{n-1})$.
...
$\displaystyle \psi \in C^k(U)$ is such that the derivatives
$\displaystyle \psi^{(j)}$ for $0\leq j \leq k$ are bounded on
...
Since $\displaystyle \tilde{f}_j \in C(\overline{\RR^n_+})$, we get from
