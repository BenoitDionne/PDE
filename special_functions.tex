...
$\displaystyle 4xy''+ 2 y' + y = 0$, then we get
\begin{align*}
0 & = 4xy''+ 2 y' + y
...
If we substitute $\displaystyle y = x^\lambda \sum_{n=0}^\infty c_n x^n$ into
$\displaystyle 2xy''+  y' + xy = 0$, then we get
\begin{align*}
0 & = 2xy''+ y' + xy \\
...
expression for $y$ into $\displaystyle (1-x^2)y''- 2x y' + 2y = 0$,
then we get
\begin{align*}
0 & = (1-x^2)y''- 2x y' + 2y
...
$\displaystyle xy''+ y' + xy = 0$, then we get
\begin{align*}
0 & = xy''+ y' + xy
...
\end{align*}
If we collect the terms in $\displaystyle x^n$ with $n$ even, and
those in $\displaystyle x^n$ with $n$ odd, then we get
\begin{align*}
...
$\displaystyle xy''+ y' + 2y = 0$, then we get
\begin{align*}
0 & = xy''+ y' + 2y
...
x^{n+\lambda}
\]
satisfies $\displaystyle xy''+ y' + 2y = \lambda^2 c_0 x^{\lambda -1}$.
...
\end{align*}
because the derivative of order $n$ of $\displaystyle x^{2n-2k}$ is zero for 
...
\]
Using integration by parts with $\displaystyle f(t) = \cos^{2n}(t)$ and
$g'(t) = \cos(t)$, so\\
$\displaystyle f'(t) = -2n \cos^{2n-1}(t)\sin(t)$ and
$g(t) = \sin(t)$, we get
\begin{align*}
...
given by $(2m-2)!$ times the coefficient of $\displaystyle x^{2m-2}$ in
\[
...
$\displaystyle (1-x^2)^{-m/2 +1}$, then we get
...
with a double integral.  With the substitution $\displaystyle t = s^2$ in
\[
...
where $n > 0$ and $\alpha_{n,k}$ is the $\displaystyle n^{th}$ zero of $J_k(x)$.
...
is complete and orthogonal in $\displaystyle L^2[0,R]$, where the
...
so $\displaystyle f'(t) = - 2\gamma_{n,k}^2 t$ and
