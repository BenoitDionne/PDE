...
\begin{proof}
\stage{i} $\displaystyle (\diff^\alpha u)(\phi)$ is well defined for all
$\phi \in \DD(\Omega)$ because $\displaystyle \diff^\alpha \phi \in \DD(\Omega)$
for all $\phi\in \DD(\Omega)$.

\stage{ii} It is easy to show that $\displaystyle \diff^\alpha u$ is a
linear functional.

\stage{iii} To prove that $\displaystyle \diff^\alpha u$ is
...
\stage{ii} The function $\displaystyle \diff^\alpha u$ can be used to define a
distribution on $\displaystyle \RR^n$ because
