...
\begin{proof}
\stage{i} We first consider $\alpha = \alpha_j \VEC{e}_j$ with
...
\stage{i} If $\displaystyle \diff^\alpha f \in H^{s,2}(\RR^n)$, then
...
\stage{i} We consider the case $|\alpha|=1$.  We have that
\begin{align*}
...
\stage{ii}  We now consider the case where $|\alpha|>1$.
...
\stage{i} Suppose that $\displaystyle \diff^\alpha f \in H^{k,2}(\Omega_r)$.
...
\stage{ii} Suppose $A_{f,\alpha} < \infty$.
